...
## Emotional Continuity Principle

Every character must show consistent emotional responses across chapters. Emotional states don't disappear without reason. If a character is scared in Ch.1, that fear should influence their behaviour in Ch.2 unless addressed.

---

## Han Seojin (Islat Han)

### Primary Emotions

| Emotion | Trigger | Response | Chapter Evidence |
|---|---|---|---|
| **Fear** | Being summoned into game | Panic, disbelief, "I'm fucked!" | Ch.2: "panics, scared, unbelieving" |
| **Anger** | Realizing he's trapped | "You damned bastard!", cursing | Ch.2: "in pain, shouts" |
| **Frustration** | Reckless master decisions | "Shit...", internal criticism | Ch.1: "Shit...", Ch.2: "I was lucky and Shay died because the master was stupid" |
| **Determination** | Survival instinct | "Watch me survive until the end", strategic planning | Ch.2: "locked in", Ch.3-8: consistent strategy |
| **Compassion** | Aaron wanting to help | Allows it, but warns | Ch.8: "It's good that you're helping them, but don't set a precedent like me" |
...
**Fear Response Chain (Ch.2):**
1. Initial panic: "What is this? Huh?"
2. Disbelief: "It's not realistic at all?!"
3. Acceptance: "But I didn't need a long time to accept reality"
4. Determination: "Watch me survive until the end"

**Anger Triggers:**
- Being deceived (Ch.8: "This is the last time I'll overlook this")
- Reckless master decisions (Ch.2: "the master was stupid")
- Weak heroes dying uselessly (Ch.1: "Shit...")

**Compassion Limits:**
- Allows Aaron to help (Ch.8) but sets boundaries
- Doesn't help weak heroes personally (Ch.1: "Ignore them. They won't be of help")
- Internal conflict: knows they'll die, but doesn't emotionally invest

**Suppression Mechanism:**
- Uses game mechanics as emotional buffer
- Refers to death as "returning to the goddess' arms"
- Treats heroes as units, not people (mostly)
- Only shows concern for core team (Jenna, Aaron)

### Emotional Gaps (Potential Issues)

| Gap | Risk | Solution |
|---|---|---|
| No grief shown for dead heroes | May seem sociopathic | Show internal conflict occasionally |
| No homesickness for Earth | May seem detached | Add internal monologue about old life |
| No fear of Niflheimr directly | May seem overconfident | Show strategic worry, not panic |
| No joy in victories | May seem robotic | Add small moments of satisfaction |
...
| Emotion | Trigger | Response | Chapter Evidence |
|---|---|---|---|
| **Curiosity** | Unknown situations | Asks questions | Ch.1: "What is it? What happened?", Ch.8: "What are they doing?" |
| **Fear** | Dangerous combat | Stat reduction, seeks guidance | Ch.1: "state of fear" notification, Ch.8: "But why is the master not going to the 5th stage?" |
| **Excitement** | New facilities | "Ooh~!", exclamations | Ch.8: "Ooh~! The building definitely got better" |
| **Hunger** | Bad food | Complaining, whining | Ch.8: "that master only made me eat potatoes here" |
...
**Trust Development:**
- Ch.1: Questioning, suspicious ("What is he going on about?")
...
- Seeks Han's guidance rather than panicking

**Emotional Expression:**
- Openly expresses feelings (hunger, excitement)
- Doesn't suppress emotions like Han
- More "human" in reactions
...
| Emotion | Trigger | Response | Chapter Evidence |
|---|---|---|---|
| **Pity** | Weak heroes suffering | Volunteers to help | Ch.8: "I'll fight with you!" |
| **Determination** | Training | First to arrive, last to leave | Ch.8: "He was the first to come to train and the last to head home" |
...
**Loyalty Chain:**
- Ch.3: First to volunteer for combat
- Ch.7: Added to favourites
- Ch.8: Training hard, following Han's lead

**Compassion Limits:**
- Wants to help weak heroes
- Doesn't question Han's thinning decisions
- Trusts Han knows best
...
| Emotion | Trigger | Response | Chapter Evidence |
|---|---|---|---|
| **Frustration** | Heroes disobeying | "Back off!", aggressive commands | Ch.1: "Shut up, shut the fuck up!", Ch.8: "What? It's not your fight, so back off." |
| **Anger** | Useless heroes | "Useless bastards!!!" | Ch.1: "Useless bastards!!! They were annihilated on the 1st floor?!" |
| **Smugness** | Authority | "Didn't I tell you..." | Ch.1: "Didn't I tell you to not act stupid unless you wanted to die?" |
| **Panic** | Unexpected events | "Ack!!! What the hell happened?" | Ch.2: when Han appears as real person |
...
- Physical demonstrations (killing Molmont)
- Verbal aggression as default

**Surprise Triggers:**
- Han knowing her name (Ch.2)
- Han being from Earth (Ch.2)
- Any deviation from expected hero behaviour

**Emotional Inconsistency Risk:**
- Ch.1: Aggressive, threatening
- Ch.2: Panicked, vulnerable
- Ch.8: Back to authoritative
...
## Shay Lathasterie (Deceased)

### Primary Emotions

| Emotion | Trigger | Response | Chapter Evidence |
|---|---|---|---|
| **Calm Acceptance** | Being sacrificed | "So this is it." | Ch.2: "So this is it." |
| **Resignation** | Not being chosen | "I wasn't chosen. That's all." | Ch.2: "I wasn't chosen. That's all." |
| **Trust** | Passing the torch | "I'll leave it to you, Han…" | Ch.2: "I'll leave it to you, Han…" |
| **Confidence** | Combat | "Are you a newbie? Your form is bad." | Ch.2: "Are you a newbie? Your form is bad." |

### Emotional Patterns

**Acceptance Chain:**
1. Confusion: "Did you summon me? Who are you?"
2. Assessment: "Are you a newbie? Your form is bad."
3. Acceptance: "So this is it."
4. Trust: "I'll leave it to you, Han…"

**Knight's Honour:**
- Doesn't fight the master's choice
- Accepts death with dignity
- Passes responsibility to Han

### Emotional Gaps

| Gap | Risk | Solution |
|---|---|---|
| No anger at being sacrificed | May seem unrealistic | Add moment of frustration before acceptance |
| No curiosity about why | May seem flat | Add question before acceptance |

---

## Molmont Carl (Deceased)

### Primary Emotions

| Emotion | Trigger | Response | Chapter Evidence |
|---|---|---|---|
| **Anger** | Being kidnapped | "DON'T SAY NONSENSE LIKE THAT!" | Ch.1: shouting |
| **Aggression** | Iselle's attitude | Ready to fight | Ch.1: "I'll teach you a lesson on manners" |
| **Fear** | Death | — | Implied by his aggressive defence |

### Emotional Patterns

**Anger Escalation:**
1. Confrontation: "Are you the one who brought us here?"
2. Escalation: "You're so shameless"
3. Attack: "I'll teach you a lesson"
4. Death: Decapitated

**Emotional Gap:**
- No fear shown before death — may be in denial
...
| Emotion | Trigger | Response | Chapter Evidence |
|---|---|---|---|
| **Fear** | Combat | "I've never held a spear before…" | Ch.1 |
| **Nervousness** | Unknown situations | Timid responses | Ch.1 |

### Emotional Pattern:
- Consistently fearful
- Dies from fear-induced distraction (goblin attack)
...
| Emotion | Trigger | Response | Chapter Evidence |
|---|---|---|---|
| **Self-Preservation** | Being replaced | "W-Wait. I will make something better!" | Ch.8 |
| **Fear** | Synthesis threat | Silence | Ch.8: "…" after threat |

### Emotional Gaps:
- No guilt for lying
- No gratitude for being spared
- May be sociopathic or just desperate
...
| Emotion | Trigger | Response | Chapter Evidence |
|---|---|---|---|
| **Confusion** | Role assignment | "Are us two doing something else?" | Ch.8 |

### Emotional Gaps:
- Minimal dialogue
- No shown emotions beyond confusion
...
| Emotion | Trigger | Response | Chapter Evidence |
|---|---|---|---|
| **Fear** | Being chosen | "M-Me?" | Ch.8 |
| **Pride** | Cooking | "Because there were many condiments…" | Ch.8 |

### Emotional Gaps:
- Minimal dialogue
- No shown emotions beyond initial fear
...
| Emotion | Trigger | Response | Chapter Evidence |
|---|---|---|---|
| **Fear** | Combat | Screaming, stat reduction | Ch.1: "state of fear" notifications |
| **Panic** | Unknown situations | "What is this?!", "Let me out!" | Ch.1 |
| **Denial** | Being forced to fight | Excuses (arthritis, stomach ache) | Ch.1: "I have arthritis!" |
| **Horror** | Death of others | Screaming, shock | Ch.1: "some scream, some shout in horror" |
...
If a character is scared in Ch.1, that fear should influence their behaviour in Ch.2 unless addressed.

### Rule 2: Emotional Triggers Are Consistent
If Han gets angry when deceived in Ch.8, he should get angry when deceived in future chapters.

### Rule 3: Emotional Growth Is Shown
Jenna's trust in Han should grow visibly across chapters (Ch.1: questioning → Ch.8: complete trust).

### Rule 4: Suppressed Emotions Surface
Han suppresses emotions, but they should surface in private moments (internal monologue).

### Rule 5: Emotional Gaps Are Filled
If a character shows no emotion where one is expected, add it (e.g., Aaron's frustration with skill plateau).

### Rule 6: Death Emotions Are Shown
Heroes facing death should show fear, acceptance, or defiance — not just silence.

---

## Emotional Matrix (Quick Reference)
