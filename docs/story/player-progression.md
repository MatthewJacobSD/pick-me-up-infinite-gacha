# Player Progression (Per Chapter)

> Player/master (ANYTNG) growth and the protagonist's (Han) progress, logged chapter by chapter.
> Complements `docs/characters/han.md`, which holds the latest-chapter snapshot.
> Viewpoint split: this file = per-chapter growth; `han.md` = current state.
...
- Han summoned into his own game as 1★ hero.
- Party 1 (Ranto, Kelcard, Jaksen, Lyle, Marlin) dies on Floor 1.
- Han meets Jenna Cirai.

### Chapter 2

- Shay (4★) sacrificed by ANYTNG.
- Han begins strategizing around the master's choices.

### Chapter 3

- Aaron summoned.
- Han forms core team (Jenna, Aaron).

### Chapter 4

- Han reaches **Lv.6** (exp 13/50).
- Acquires **Pain Tolerance**, then **Basic Sword-Shield Techniques (Lv.3)**.
- Han + Jenna level up; Jenna gains 'Eagle's Eye'.

### Chapter 5

- First synthesis (Toby sacrificed) → Han **level up to Lv.7**, obtains **Composure**.
- Second synthesis (Yelson sacrificed).
- Blacksmith's forge annex unlocked; weapons storage upgraded.

### Chapter 6

- Han reveals he knows Niflheimr's secrets.

### Chapter 7

- Floor 4 cleared.
- Han crafts 3 weapons (Shortbow, Long Spear, Iron Shield).
- Aaron added to favourites; Aaron levels up.
- Facilities upgraded (Lodging, Restaurant, Training Center, Workshop, Square).
- Niflheimr's elite 5 revealed; Sirris dispatched; Yurneth investigates master.

### Chapter 8

- New summoning (10 heroes, 1 death in thinning).
- Combat team (6 members) + Support team (2 members) formed.
- Non-combat roles assigned (Chloe = cook, Enok = carpenter).
- Training begins (Gide, Hansen, Dika).
- Jenna's archery reaches Lv.5; Aaron's spear stuck at Lv.2.
...
- Repeated panels between chapters are intentional; no need to log repeats as new events.
