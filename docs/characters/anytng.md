...
> The player controlling the lounge. Reckless spender, office worker from Earth.
...
|---|---|
| Account Name | ANYTNG |
| Real Identity | Human from Earth (office worker) |
| Rank | Unknown ("semi-newbie"; spending has grown from 65,000-won packages to 90,000-won double packages) |
| Play Style | Reckless, impulsive, doesn't optimize |

---

## Personality Traits

- **Reckless**: Sacrificed 4★ Shay to enhance 1★ Han without thinking
- **Impulsive**: Spends gems on summoning instead of upgrades
- **Busy**: Limited online time (probably an office worker)
- **Curious**: Does research, spends money on the game
- **Oblivious**: Doesn't know heroes are real humans; approved a lethal duel without knowing the duel system existed (Ch. 17)
- **Vengeful when provoked**: After losing all five Pulverizing Wolves, vented his fury by synthesizing six slacker heroes into Edis (Ch. 18)

---

## Key Moments

1. **Ch. 1**: Summoned heroes, started tutorial
2. **Ch. 2**: Sacrificed 4★ Shay to synthesize with 1★ Han
3. **Ch. 3**: Logged in after 3 days, summoned more heroes
4. **Ch. 4**: Logged off after clearing Floor 2
5. **Ch. 5**: Followed Iselle's tips (training center, blacksmith)
6. **Ch. 6**: Han revealed he knows the master is human
7. **Ch. 7**: Spent gems on upgrades, online time limited
8. **Ch. 8**: Conducted thinning, summoned more heroes
9. **Ch. 15**: Bought the 'newbie potent package' (50,000 won); consecutive summon produced the 5× 3★ Pulverizing Wolves via affinity link
10. **Ch. 16**: Ran another 10 consecutive summons and synthesized immediately — Diman & Lexigel consumed without examination; Han sent a warning TIP
11. **Ch. 17**: Approved Han's Open Duel vs Avant via Yes/No prompt without understanding it; too late to cancel — lost all five Wolves for nothing
...
| Aspect | Details |
|---|---|
| Package Cost | Escalating: 65,000 won (early) → 'newbie potent package' 50,000 won → 2,500 gems + 50,000 gold (Ch. 15) → 'newbie potent double package!' 90,000 won → 5,000 gems + 100,000 gold (Ch. 19) |
| Payment Method | Charged to next month's phone bill (Ch. 19) |
| High-Rank Summons | 2 consecutive for 1,000 gems → **Rare Eolka (3★ Magician) + Rare Roderick (3★ Guard)** (Ch. 20) |
| Priority | Summoning over upgrades |
...
- His reckless decisions directly affect hero survival
- Han watches his own game being played poorly
- The master's limited time creates pressure on heroes
- His spending keeps the lounge running
