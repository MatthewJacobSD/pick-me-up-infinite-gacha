...
> Protagonist. Real player from Earth, now trapped in his own game.
...
| Field | Value |
|---|---|
| Real Name | Han Seojin |
| In-Game Name | Han Islat |
| Origin | Seoul, Gangseo-Gu, South Earth |
| Star Rank | 1★ |
| Class | Novice |
| God Identity | **Loki** (Rank 5, "Master of Masters") |
| Summoned By | Level 999 bugged entity (God of Death) |

---

## Personality Traits

- **Calculative**: Always thinking 3 steps ahead, knows game mechanics inside out
- **Emotionally Guarded**: Doesn't show feelings, keeps distance from allies
- **Pragmatic**: Will sacrifice weak heroes without hesitation
- **Observant**: Notices details others miss (skills, stats, behaviors)
- **Protective**: Despite cold exterior, cares about his core team
- **Self-Deprecating**: Knows he's trapped, accepts his fate with dark humor
...
1. **Ch. 1**: Accepted his fate as a 1★ hero
2. **Ch. 4**: Formed Jenna + Aaron core team
3. **Ch. 5**: Used synthesis (sacrificed Toby, Yelson) to strengthen team
...
16. **Ch. 18**: Let ANYTNG's rage-synthesis of the six slackers play out (predicted Edis as target); delivered the survival doctrine to the remainder ("prove that you're useful") and built a mentor framework — trades to Chloe/Enok/Alter/Patrick, hunting/butchering to Jenna, carpentry to Enok, fighters to himself ("I'll beat you to a pulp"); privately judged the six as eventual fodder and decided a second party is needed before Floor 10
17. **Ch. 19**: Hand-picked Usher Roderick for a potential test; engineered the two-party split via lots at dawn ("The master probably won't be able to reject") with himself and Edis as leaders; on Floor 7 soloed most of the stage in Berserk mode but left one goblin alive over a suspected dam-collapse linked quest — MVP again
18. **Ch. 20**: Predicted the master's post-purchase spending spiral; ran the lot contest against Edis (both caught cheating by Jenna); initially wanted the veteran guard ("It's obvious who's the better choice") but accepted Eolka for archer synergy once her fire magic surfaced; used Yon & Zenin's synthesis as a live object lesson for the newcomers; opened Eolka's interrogation — fight or become fodder
...
26. **Ch. 28**: Diagnosed the decorated commander's counter (charges timed to Eolka's cast delay) and refused to grind forward — called the all-in: kill the commander or die in the fire zone; the double-cast kill collapsed the horde back onto its fortress objective and Party 1 slipped past; enforced potion rationing at one per person; walked the party into an Ogre Lv.23 wave with "They brought a big friend."
